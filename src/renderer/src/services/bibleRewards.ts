...
export const BADGES: Badge[] = [
  ...
  { id: 'course-ruth',           name: 'Loyalty in a Famine', requirement: 'Finish Ruth: Loyalty in a Famine' },
  { id: 'course-1samuel',        name: 'Choosing a King', requirement: 'Finish Samuel and David: Choosing a King' },
  { id: 'course-job',            name: 'No Answer Given', requirement: 'Finish Job: When There Is No Answer' },
  { id: 'course-ecclesiastes',   name: 'Under the Sun',  requirement: 'Finish Ecclesiastes: Under the Sun' },
  { id: 'course-isaiah',         name: 'Comfort and the Servant', requirement: 'Finish Isaiah: Comfort and the Servant' },
  { id: 'course-daniel',         name: 'Faith in Exile', requirement: 'Finish Daniel: Faith in Exile' },
  { id: 'course-jonah',          name: 'The Reluctant Prophet', requirement: 'Finish Jonah: The Reluctant Prophet' },
  { id: 'course-matthew',        name: 'The Sermon on the Mount', requirement: 'Finish Matthew: The Sermon on the Mount' },
  { id: 'course-1corinthians',   name: 'A Difficult Church', requirement: 'Finish 1 Corinthians: A Difficult Church' },
  { id: 'course-ephesians',      name: 'The New Humanity', requirement: 'Finish Ephesians: Grace and the New Humanity' },
  { id: 'course-philippians',    name: 'Joy from a Cell', requirement: 'Finish Philippians: Joy from a Prison Cell' },
  { id: 'course-hebrews',        name: 'Better Things',   requirement: 'Finish Hebrews: Better Things' },
  { id: 'course-james',          name: 'Faith That Works', requirement: 'Finish James: Faith That Works' },
  { id: 'course-1john',          name: 'Light and Love',  requirement: 'Finish 1 John: Light, Love and Assurance' },
  { id: 'course-revelation',     name: 'Hope Under Pressure', requirement: 'Finish Revelation: Hope Under Pressure' },
  {
